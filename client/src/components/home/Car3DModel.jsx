...
function FallbackImage() {
  return (
    <div className="relative">
      <div className="absolute inset-0 bg-gradient-to-br from-pink-500/30 to-pink-500/5 rounded-full filter blur-3xl transform -rotate-12 pointer-events-none"></div>
      <img
        src={assets.car}
        alt="Luxury Car"
  ...
  return (
    <div className="flex items-center justify-center h-full w-full absolute inset-0 z-20">
      <div className="relative w-16 h-16">
        <div className="absolute inset-0 border-4 border-pink-200 dark:border-pink-900/30 rounded-full"></div>
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-4 left-4 z-50 p-3 bg-pink-500 hover:bg-pink-600 text-white rounded-full shadow-lg transition-all"
        ...
        <div>
          ...
          {['x', 'y', 'z'].map(axis => (
            <div key={axis} className="flex items-center gap-1 mb-1">
              ...
              <button onClick={() => adjustValue('position', axis, -0.5)} className="px-1.5 py-0.5 bg-pink-500 text-white rounded text-[10px]">-</button>
